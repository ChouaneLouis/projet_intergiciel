...
public class InfoServerImpl extends UnicastRemoteObject implements InfoServer {

        Map<String, HRecord> hotelMap;

        public InfoServerImpl() throws RemoteException {
                this.hotelMap = initMap();
        }

        @Override
        public HRecord getDataFromName(String name) throws RemoteException, NoSuchElementException {
        ...
        public static void main(String[] args) {
                ...
                try {
                        registry = LocateRegistry.getRegistry(2000);// use any no. less than 55000
                        registry.list();
                ...
                try {
                        InfoServer is = new InfoServerImpl();
                        Naming.rebind("//" + InetAddress.getLocalHost().getHostName() + ":" + 2000 + "/infoserver", is);
